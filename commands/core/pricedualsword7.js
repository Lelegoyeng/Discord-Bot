...
module.exports = {
    name: 'pricedualsword7',
    description: "List Price Dual Sword 7.1",

    async execute({ client, inter }) {
        const BlacMarket = await axios.get(`https://www.albion-online-data.com/api/v2/stats/prices/T7_2H_DUALSWORD@1?locations=Blackmarket`);
        const Caerleon = await axios.get(`https://www.albion-online-data.com/api/v2/stats/prices/T7_2H_DUALSWORD@1?locations=caerleon`);
        ...
        .setThumbnail('https://cdn.discordapp.com/icons/760431384127864842/cfa7adbca196b7c7965525d4c9993eb5.webp?size=96')
            ...
            .setAuthor({ name: `🍟 Price Dual Sword 7.1` })
