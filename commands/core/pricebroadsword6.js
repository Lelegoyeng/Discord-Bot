...
module.exports = {
    name: 'pricebroadsword6',
    description: "List Price BroadSword 6.1",

    async execute({ client, inter }) {
        const BlacMarket = await axios.get(`https://www.albion-online-data.com/api/v2/stats/prices/T6_MAIN_SWORD@1?locations=Blackmarket`);
        const Caerleon = await axios.get(`https://www.albion-online-data.com/api/v2/stats/prices/T6_MAIN_SWORD@1?locations=caerleon`);
