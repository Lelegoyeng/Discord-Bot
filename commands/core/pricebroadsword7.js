...
module.exports = {
    name: 'pricebroadsword7',
    description: "List Price BroadSword 7.1",

    async execute({ client, inter }) {
        const BlacMarket = await axios.get(`https://www.albion-online-data.com/api/v2/stats/prices/T7_MAIN_SWORD@1?locations=Blackmarket`);
        const Caerleon = await axios.get(`https://www.albion-online-data.com/api/v2/stats/prices/T7_MAIN_SWORD@1?locations=caerleon`);
        ...
        .setThumbnail('https://cdn.discordapp.com/icons/760431384127864842/cfa7adbca196b7c7965525d4c9993eb5.webp?size=96')
            ...
            .setAuthor({ name: `🍟 Price BroadSword 7.1` })
